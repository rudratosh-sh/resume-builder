! function(e, s, i) {
    ...
    i(s).ready(function() { 
        ...
        t.on("click", ".navigation-main .nav-item a", function() {
            ...
            ap.hasClass("sidebar-mini")?(ap.removeClass("sidebar-mini")):ap.addClass("sidebar-mini")
        }), n.on("mouseenter", function() {
            if (ap.hasClass("sidebar-mini")) {
                ap.addClass("sidebar-mini-hover")
            }
            ...
            ap.removeClass('sidebar-mini-hover')
            if (l.hasClass("nav-collapsed")) {
