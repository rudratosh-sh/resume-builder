<div class="app-sidebar colored">
    <div class="sidebar-header">
        <a class="header-brand" href="{{route('dashboard')}}">
            <div class="logo-img">
               <img height="30" src="{{ asset('img/logo_white.png')}}" class="header-brand-img" title="Resume Builder"> 
            </div>
        </a>
    ...
    <div class="sidebar-content">
        <div class="nav-container">
            <nav id="main-menu-navigation" class="navigation-main">
                ...
                <div class="nav-lavel">{{ __('Access Control')}} </div>
                ...
                <div class="nav-item {{ ($segment1 == 'customers') ? 'active' : '' }}">
                    <a href="{{url('customers')}}"><i class="ik ik-users"></i><span>{{ __('Customers')}}</span></a>
                </div>
        </div>
    </div>
</div>